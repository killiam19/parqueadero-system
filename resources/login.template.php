...
<div class="w-full max-w-xl mx-auto">
    <form action="/login" method="POST">
        ...
        <div class="mt-4">
            ...
            <p class="text-gray-500 dark:text-gray-400">¿Aún no tienes una cuenta?<a href="/registrar" class="inline-flex items-center font-medium text-blue-600 dark:text-blue-500 hover:underline">
            Regístrate
