...
<div class="container mx-auto px-4">
    <div class="nav text-center mb-8">
        ...
        <a href="/admin" class="inline-block px-4 py-2 mx-2 text-blue-600 border border-blue-600 rounded hover:bg-blue-600 hover:text-white transition">Administración</a>
    </div>
                ...
                <form method="POST" action="">
                    ...
                    <div class="grid grid-cols-2">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="s_nombre" id="s_nombre" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="s_apellido" id="s_apellido" required>
                        </div>
                    </div>
                    ...
                    <?php foreach ($usuarios as $usuario): ?>
                        <div class="usuario-item">
                            <div class="usuario-info">
                                <h4><?php echo htmlspecialchars($usuario['nombres']); ?></h4>
