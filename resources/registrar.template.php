...
<form class="max-w-sm mx-auto">
  ...
  <div class="flex items-start mb-5">
    ...
    <label for="terms" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">He leído y acepto el <a href="#" class="text-blue-600 hover:underline dark:text-blue-500">Reglamento del parqueadero</a></label>
  </div>
